...
public class TicketTestEsc1 {
    ...
    public void testGetComparacionRenumeracion1(){
        Assert.assertEquals(("No coincide  renum"),1,ticket.getComparacionRemuneracion(ticket),0.0001);
    }

    @Test
    public void testGetComparacionRenumeracion2(){
        Assert.assertEquals(("No coincide  renum"),-0.5,ticket.getComparacionRemuneracion(ticket2),0.0001);
    }

    @Test
    public void testGetComparacionRenumeracion3(){
        Assert.assertEquals(("No coincide  renum"),-1,ticket.getComparacionRemuneracion(ticket3),0.0001);
    }
